...
const common = {
  ...
  referenceLength: 1,
  coupling: 1,
  scf: { tolerance: 1e-6, energyTolerance: 1e-8, maxIterations: 200, mixing: 0.16, acceleration: 'kinetic-preconditioner' as const, preconditionerShift: 1.25, andersonHistory: 4, andersonRegularization: 1e-8, allowUnconvergedDynamics: false },
